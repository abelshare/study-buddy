...
1. **[开发环境](/domains/python/env/)** - 虚拟环境、包管理、工具选择（建议先看）
2. **[基础语法对照](/domains/python/syntax/)** - 变量、函数、控制流（与 JS 对照学习）
3. **[数据结构](/domains/python/data-structures/)** - 列表、字典、元组、集合
4. **[常用内置功能](/domains/python/built-in/)** - 文件操作、字符串处理、日期时间
...
- [Python 开发环境](/domains/python/env/) - 虚拟环境与包管理
